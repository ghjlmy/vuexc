<template>
  <div class="flex flex-col h-screen bg-gray-50">
    ...
    <main class="flex-1 flex overflow-hidden">
      <aside class="w-80 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 overflow-y-auto">
        <div class="p-4 border-b border-gray-200">
          <h3 class="font-bold text-gray-800 mb-3 flex items-center gap-1">
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            <span class="text-sm text-gray-600">步</span>
          </div>
        </div>
        
        <div class="flex-1 overflow-y-auto p-4">
          <div v-if="newTaskSteps.length === 0" class="h-full flex flex-col items-center justify-center text-gray-400">
            <i class="fa fa-list-ul text-4xl mb-3"></i>
            <p class="text-sm text-center">从右侧选择点位添加到任务步骤</p>
          </div>
